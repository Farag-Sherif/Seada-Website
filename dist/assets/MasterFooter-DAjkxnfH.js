import{j as a,r as u,u as J}from"./index-DweZ4P2R.js";import{C}from"./Container-DxkBgcFy.js";import{N as j}from"./NextLinkCompat-BNIdmUEC.js";import{g as Z}from"./categories-D-E80POk.js";import{u as k}from"./useLanguage-BDBuB9CT.js";import{S as R}from"./StyleTag-D38Rn_4I.js";import{R as ee,C as N}from"./Col-sODIRSUs.js";import{g as ae,k as re,a as oe,b as te,c as se}from"./main-DkAwJllx.js";const Q=({logo:e})=>a.jsx(u.Fragment,{children:a.jsx(j,{href:"/",children:a.jsx("img",{src:`/assets/images/icon/${e||"logo.png"}`,alt:"",style:{height:"80px"}})})}),S=(e,o)=>{var d,r;const l=Array.isArray(e==null?void 0:e.translations)?e.translations:[],c=o?"ar":"en";return((d=l.find(n=>(n==null?void 0:n.locale)===c))==null?void 0:d.name)||((r=l.find(n=>n==null?void 0:n.locale))==null?void 0:r.name)||(e==null?void 0:e.name)||""},ne=e=>[e==null?void 0:e.sub_categories,e==null?void 0:e.subCategories,e==null?void 0:e.children,e==null?void 0:e.subs,e==null?void 0:e.sub_cats].find(Array.isArray)||[],ie=(e="")=>{const o=String(e).toLowerCase();return o.includes("fruit")||o.includes("vegetable")||o.includes("خض")?"🍎":o.includes("meat")||o.includes("poultry")||o.includes("لحوم")?"🥩":o.includes("dairy")||o.includes("egg")||o.includes("ألبان")||o.includes("بيض")?"🥛":o.includes("bakery")||o.includes("مخبوز")?"🥖":o.includes("beverage")||o.includes("مشروب")?"🥤":"•"},le=()=>{const{isRTL:e}=k(),o=u.useRef(null),[l,c]=u.useState([]),[d,r]=u.useState(!1),[n,v]=u.useState(null),b=()=>r(!1);u.useEffect(()=>{let t=!0;return(async()=>{var p;try{const h=await Z(),f=Array.isArray(h==null?void 0:h.data)?h.data:Array.isArray(h)?h:[];if(!t)return;c(f.slice(0,8)),v(((p=f[0])==null?void 0:p.id)??null)}catch{if(!t)return;c([])}})(),()=>{t=!1}},[]),u.useEffect(()=>(document.body.style.overflow=d?"hidden":"",()=>{document.body.style.overflow=""}),[d]),u.useEffect(()=>{const t=h=>h.key==="Escape"&&b(),p=()=>r(!0);return document.addEventListener("keydown",t),window.addEventListener("open-sidebar",p),()=>{document.removeEventListener("keydown",t),window.removeEventListener("open-sidebar",p)}},[]);const A=u.useMemo(()=>[{href:"/",label:e?"الرئيسية":"Home",icon:"🏠"},{href:"/about",label:e?"من نحن":"About Us",icon:"🏢"},{href:"/products",label:e?"المنتجات":"Products",icon:"📦"},{href:"/consultation",label:e?"استشارة":"Consultation",icon:"🤝"},{href:"/contact",label:e?"تواصل معنا":"Contact",icon:"✉️"}],[e]),s=(t,p)=>{if(p.startsWith("/#")||p.startsWith("#")){t.preventDefault();const h=p.replace("/#","").replace("#",""),f=document.getElementById(h);f?f.scrollIntoView({behavior:"smooth",block:"start"}):window.location.href=p,b()}};return a.jsxs(a.Fragment,{children:[a.jsxs("div",{id:"mySidenav",className:`seada-sidebar-root ${d?"open-side":""}`,dir:e?"rtl":"ltr","aria-hidden":!d,children:[a.jsx("div",{className:"seada-sidebar-backdrop",onClick:b}),a.jsxs("aside",{ref:o,className:"seada-sidebar-panel",role:"dialog","aria-modal":"true",children:[a.jsxs("div",{className:"seada-sidebar-head",children:[a.jsx("a",{href:"/",className:"seada-sidebar-logo",onClick:b,children:a.jsx("img",{src:"/assets/images/icon/logo/6.png",alt:"Seada",style:{filter:"brightness(0) invert(0)"}})}),a.jsx("button",{className:"seada-sidebar-close",onClick:b,"aria-label":e?"إغلاق":"Close sidebar",children:"×"})]}),a.jsxs("div",{className:"seada-sidebar-quicklinks",children:[a.jsx("h5",{className:"sidebar-section-title",children:e?"القائمة الرئيسية":"Main Menu"}),A.map(t=>a.jsxs("a",{href:t.href,onClick:p=>s(p,t.href),className:"seada-sidebar-link secondary",children:[a.jsx("span",{className:"seada-sidebar-emoji",children:t.icon}),a.jsx("span",{children:t.label})]},t.href))]}),a.jsxs("div",{className:"seada-sidebar-list",style:{marginTop:24},children:[a.jsx("h5",{className:"sidebar-section-title",children:e?"فئات المنتجات":"Product Categories"}),l.map(t=>{const p=S(t,e),h=ne(t),f=String(n??"")===String((t==null?void 0:t.id)??"");return a.jsxs("div",{className:"seada-sidebar-group",children:[a.jsxs("button",{className:`seada-sidebar-link ${f?"active":""}`,type:"button",onClick:()=>v(f?null:t==null?void 0:t.id),children:[a.jsx("span",{className:"seada-sidebar-emoji",children:ie(p)}),a.jsx("span",{children:p}),a.jsx("i",{className:`fa ${f?"fa-angle-up":"fa-angle-down"}`,"aria-hidden":"true"})]}),f&&h.length?a.jsx("div",{className:"seada-sidebar-children",children:h.slice(0,5).map(x=>a.jsx(j,{href:`/shop/sidebar_popup?category_id=${encodeURIComponent((x==null?void 0:x.id)||(t==null?void 0:t.id)||"")}`,onClick:b,children:S(x,e)},(x==null?void 0:x.id)||S(x,e)))}):null]},(t==null?void 0:t.id)||p)})]})]})]}),a.jsx(R,{global:!0,css:`
      ...
      `})]})},ue=[{lang:"English",val:"en"},{lang:"العربية",val:"ar"}],q=({className:e="",showLabel:o=!0})=>{const{currentLanguage:l,changeLanguage:c,isRTL:d}=k();return a.jsxs("div",{className:`language-switcher ${e}`,children:[o&&a.jsx("span",{className:"language-label",style:{marginRight:d?0:"10px",marginLeft:d?"10px":0},children:d?"اللغة:":"Language:"}),a.jsx("select",{value:l,onChange:r=>c(r.target.value),className:"language-select",style:{direction:d?"rtl":"ltr"},children:ue.map(r=>a.jsx("option",{value:r.val,children:r.lang},r.val))})]})},B=[{href:"/",labelEn:"Home",labelAr:"الرئيسية"},{href:"/about",labelEn:"About Us",labelAr:"من نحن"},{href:"/products",labelEn:"Products",labelAr:"المنتجات"},{href:"/consultation",labelEn:"Consultation",labelAr:"استشارة"},{href:"/contact",labelEn:"Contact Us",labelAr:"تواصل معنا"}],ke=({logoName:e,headerClass:o})=>{const l=J(),{isRTL:c}=k(),[d,r]=u.useState(!1),[n,v]=u.useState(!1);u.useEffect(()=>{const s=()=>r(window.scrollY>20);return window.addEventListener("scroll",s,{passive:!0}),()=>window.removeEventListener("scroll",s)},[]),u.useEffect(()=>{const s=setTimeout(()=>{document.querySelectorAll(".loader-wrapper").forEach(t=>t.style.display="none")},900);return()=>clearTimeout(s)},[]),u.useEffect(()=>{if(n){const s=()=>v(!1);return window.addEventListener("scroll",s,{passive:!0}),()=>window.removeEventListener("scroll",s)}},[n]);const b=(s,t)=>{if(t.startsWith("/#")||t.startsWith("#")){const p=t.replace("/#","").replace("#",""),h=document.getElementById(p);h&&(s.preventDefault(),h.scrollIntoView({behavior:"smooth",block:"start"})),v(!1)}},A=l.pathname!=="/";return a.jsxs("div",{children:[a.jsxs("header",{className:`corp-header ${o||""} ${d||A?"is-scrolled":""}`,children:[a.jsx(C,{children:a.jsxs("div",{className:"corp-header-inner",children:[a.jsx("div",{className:"corp-header-logo",children:a.jsx(Q,{logo:e})}),a.jsx("nav",{className:"corp-nav d-none d-lg-flex",children:B.map(s=>a.jsx(j,{to:s.href,className:"corp-nav-link",onClick:t=>b(t,s.href),children:c?s.labelAr:s.labelEn},s.href))}),a.jsxs("div",{className:"corp-header-actions d-none d-lg-flex",children:[a.jsx(q,{showLabel:!1}),a.jsx(j,{to:"/contact",className:"corp-btn corp-btn-primary corp-btn-sm",onClick:s=>b(s,"/contact"),children:c?"طلب عرض سعر":"Get a Quote"})]}),a.jsxs("button",{className:"corp-mobile-toggle d-lg-none",type:"button",onClick:()=>v(s=>!s),"aria-label":c?"فتح القائمة":"Open menu",children:[a.jsx("span",{className:n?"open":""}),a.jsx("span",{className:n?"open":""}),a.jsx("span",{className:n?"open":""})]})]})}),a.jsx("div",{className:`corp-mobile-menu d-lg-none ${n?"open":""}`,children:a.jsx(C,{children:a.jsxs("nav",{className:"corp-mobile-nav",children:[B.map(s=>a.jsx(j,{to:s.href,className:"corp-mobile-nav-link",onClick:t=>b(t,s.href),children:c?s.labelAr:s.labelEn},s.href)),a.jsx("div",{style:{padding:"0 16px",marginTop:"8px",marginBottom:"8px"},children:a.jsx(q,{showLabel:!1})}),a.jsx(j,{to:"/contact",className:"corp-btn corp-btn-primary corp-btn-sm",onClick:s=>b(s,"/contact"),style:{marginTop:12,width:"100%",justifyContent:"center"},children:c?"طلب عرض سعر":"Get a Quote"})]})})})]}),a.jsx(le,{}),a.jsx(R,{global:!0,css:`
